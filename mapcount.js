...
$.getScript(
    ...
    async function () {
        ...
        function mapTroopColumns() {
            ...
            jQuery('table.vis.w100 thead tr th img').each(function(index) {
                ...
                switch(title) {
                    ...
                    default:
                        console.warn(`Tropa não mapeada: ${title}`);
                        break;
                }
            });
        ...
        function updateMap(villages) {
            ...
            // Mapeamento de ícones das tropas com URLs completas
            const unitIcons = {
                    ...
                    for (var y in data.tiles[x]) {
                        ...
                        if (v) {
                            ...
                            if (villageCoords.includes(vCoords)) {
                                ...
                                if (DEBUG) {
                                    console.log(`Aldeia: ${currentVillage.name}, Tropas exibidas:`, currentVillage.troops);
                                }
                            }
                        }
                    }
